...
class CartonGapPrint extends Component
{
    public $cust;
    public $stlye;
    public $idp;
...
");
        ...
        return view('livewire.carton-gap-print', compact('items', 'gid', 'grouped_items', 'total', 'cek', 'grouped_stock'))->extends('layout.print')->section('container');
    }
}