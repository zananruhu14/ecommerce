...
class Cartontarget extends Component
{
    public $p = "42";
    public $l = "27";
    public $t = "22";
    ...
    public function render()
    {
        ...
        $results = Carton::query_target($this->p, $this->l, $this->t);
        ...
        $grouped_items = Carton::query_acce_target();
        ...
        return view('livewire.cartontarget', compact('hasil', 'style', 'idp', 'total_pcs', 'total_cnt', 'grouped_stock', 'dimensions'))->extends('layout.dashboard')->section('container');
    }
}
