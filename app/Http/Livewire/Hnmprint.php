...
class Hnmprint extends Component
{
    ...
    {
        $results = Carton::query_carton($this->awal, $this->akhir);
        $count = 0;
        ...
        return view('livewire.hnmprint', compact('results', 'ukuranJumlah', 'ukuranSolid', 'formattedSpecs', 'solid', 'grouped_stock', 'count'))->extends('layout.print')->section('container');
    }
}
