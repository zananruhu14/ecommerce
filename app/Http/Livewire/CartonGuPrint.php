...
class CartonGuPrint extends Component
{
    public $cust;
    public $stlye;
    public $idp;
...
");
        ...
        return view('livewire.carton-gu-print', compact('items', 'gid', 'grouped_items', 'total', 'cek', 'grouped_stock'))->extends('layout.print')->section('container');
    }
}