            ...
            <div class="modal-header">
              ...
              <button type="button" class="btn-close text-dark" data-bs-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">×</span>
                  ...
                  <h6 class="text-white text-sm font-weight-bold mb-0">Jenis Pembayaran : {{ $pembayaran->name }}</h6>
                  <h6 class="text-white text-sm font-weight-bold mb-0">@currency($view_jumlah)</h6>
