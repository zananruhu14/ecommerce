<div>
    ...
    <div class="d-sm-flex justify-content-between mt-3">
        ...
        <div class="d-flex">
            <select class="btn bg-gradient-light dropdown-toggle" wire:model="podol">
        ...
        <div class="d-flex px-2">
            <div class="form-group">
                <div class="input-group">
                  <span class="input-group-text bg-gradient-light" id="inputGroup-sizing-default">Search ID</span>

                  <input type="text" class="form-control bg-gradient-light" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default" wire:model="tai">
                  <div id="reportrange" class="bg-gradient-light" style=" cursor: pointer; padding: 5px 10px; border: 1px solid #ccc; width: 100%">
                    <i class="fa fa-calendar"></i>&nbsp;
                    <span >{{ $start }} to {{ $end }}</span> <i class="fa fa-caret-down"></i>
                </div>
      ...
      <td style="max-width: 50px;" >
        ...
        <td class="text-xs font-weight-bold">
            ...
            <button class="btn btn-block bg-gradient-danger  border-0r"   wire:click="tanggal()"><i class="bi bi-trash"></i> Reject</button>
        </td>
        @endcan
        ...
        function cb(start, end) {
            let awal =start.format('YYYY-MM-DD 00:00:00');
            let akhir =  end.format('YYYY-MM-DD 23:59:59');
            window.livewire.emit('updateDates', awal, akhir);
