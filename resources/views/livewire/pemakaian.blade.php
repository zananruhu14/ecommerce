...
<div class="row mb-2">
    ...
    <p class="text-sm mb-1 text-capitalize font-weight-bold">Total {{ __('cost') }} WWTP</p>
    ...
    <div class="row">
    <div class="col-7 text-start">
    <p class="text-sm mb-1 text-capitalize font-weight-bold">Total {{ __('cost') }} STP</p>
    <h5 class="font-weight-bolder mb-0">
    ...
    <div class="row">
        ...
        <div class="table-responsive table-bordered">
            <table class="table table-striped table-bordered" id="datatable-search">
                ...
                <th rowspan="2" class="text-sm text-dark" style="vertical-align : middle;text-align:center;">WWTP {{ __('in') }} M³</th>
                <th rowspan="2" class="text-sm text-dark" style="vertical-align : middle;text-align:center;">WWTP {{ __('out') }} M³</th>
