    ...
    <div class="row my-3 justify-content-between">
        ...
        <div class="col-3">
            ...
            <div class="input-group mb-3">
                <input type="text" class="form-control" placeholder="Masukan Cust PO ..." aria-label="Recipient's username" aria-describedby="button-addon2" wire:model="search">
                <button class="btn btn-outline-primary mb-0" type="submit" id="button-addon2">Query</button>
              </div>
            </form>
            </div>
        </div>
