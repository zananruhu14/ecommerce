<div>
    <div>
        @include('livewire.pemasukansumbanganshow')
        @include('livewire.pemasukansumbanganedit')
          <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
              <h1 class="h2">List Pemasukan {{ $pembayaran->name }}  : {{ $this->kategori->name }}</h1>
            </div>
          ...
          <div class="card-body">
            ...
            @endif
              <div>
                  @include('livewire.pemasukansumbangancreate')
                      ...
                      <div class="table-responsive p-0">
                          ...
                          <thead>
                            <tr>
                              ...
                              <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Nama Penyumbang</th>
                              <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Jumlah</th>
                              <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Jenis Sumbangan</th>
                            ...
                            <tr>
                              ...
                              <td>
                                <div class="d-flex py-1">
                                  <div class="d-flex flex-column justify-content-center">
                                    <h6 class="mb-0 text-sm">{{ $sumbangan->jenis_sumbangan }}</h6>
                                  </div>
                                </div>
                              </td>
                              <td>
