                  ...
                  <tr>
                    <td>
                      ...
                      <td>
                        <div class="d-flex px-2 py-1">
                          <div class="d-flex flex-column justify-content-center">
                            <h6 class="mb-0 text-sm">{{ $item['_Acce_Name'] }}</h6>
                          </div>
                        </div>
                      </td>
                      ...
                      <td style="max-width: 200px; overflow: text-wrap;">
                        <div class="d-flex px-2 py-1" >
                          <div class="d-flex flex-column justify-content-center" >
                            <h6 class="mb-0 text-sm text-wrap">{{ $item['xSpec'] }}</h6>
                          </div>
                        </div>
                      </td>
                      <td style="max-width: 200px; overflow: text-wrap;">
                        <div class="d-flex px-2 py-1">
                          <div class="d-flex flex-column justify-content-center"  >
                            <h6 class="mb-0 text-sm text-wrap">{{ $item['xDesc'] }}</h6>
                          </div>
                        </div>
                      </td>
                      <td>
                        <div class="d-flex px-2 py-1">
                          <div class="d-flex flex-column justify-content-center">
                            <h6 class="mb-0 text-sm">{{ $item['_Cust_Symbol'] }}</h6>
                          </div>
                        </div>
                      </td>
                      <td>
                        <div class="d-flex px-2 py-1">
                          <div class="d-flex flex-column justify-content-center">
                            <h6 class="mb-0 text-sm">{{ $item['xBuyNo'] }}</h6>
                          </div>
                        </div>
                      </td>
                      <td>
                        <div class="d-flex px-2 py-1">
                          <div class="d-flex flex-column justify-content-center">
                            <h6 class="mb-0 text-sm">{{ $item['xNpb'] }}</h6>
                          </div>
                        </div>
                      </td>
                      <td>
                      ...
                      <td>
                        <div class="d-flex px-2 py-1">
                          <div class="d-flex flex-column justify-content-center">
                            <button class="btn btn-block bg-gradient-success  border-0"  wire:click="addConsumble({{ $item['sIndex'] }})"><i class="bi bi-basket"></i> Add to Consumable</button>
                            <button class="btn btn-block bg-gradient-primary  border-0r"  wire:click="addAsset({{ $item['sIndex'] }})"> <i class="bi bi-shop-window"></i> Add to Asset</button>
                          </div>
                        </div>
                      </td>
                  </tr>
