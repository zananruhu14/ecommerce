      ...
      <div class="modal-dialog modal-danger modal-dialog-centered modal-" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h6 class="modal-title" id="modal-title-notification">Informasi Pengeluaran</h6>
          ...
          <div class="modal-body">
            <div class="py-3 text-center">
                ...
                <h4 class="text-gradient text-danger mt-4">Detail Pengeluaran</h4>
              </div>
              <div class="form-group">
                <label >Dibuat / Dikeluarakan oleh :</label>
        ...
        <div class="card card-frame">
          ...
          <div class="modal-footer">
            <button type="button" class="btn btn-link text-white ml-auto bg-danger" data-bs-dismiss="modal">Close</button>
          </div>
        </div>
      </div>
    </div>
