<div>
    <header>
        ...
        <h1 class="text-gradient text-primary mb-0">{{ $movies['title'] }}</h1>
                        ...
                        <div class="col">
                          <div class="card h-100">
                            <a href="/test/{{ $movie['id']}}">
                              <img src="{{ 'https://image.tmdb.org/t/p/w500/' . $movie['poster_path'] }}" class="card-img-top rounded-lg" alt="{{ $movie['title'] }}">
                            </a>
                            <div class="card-body">
