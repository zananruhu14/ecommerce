<div>
    ...
    <div class="d-sm-flex justify-content-between">
        <div>
            <button class="btn btn-block bg-gradient-primary  border-0" data-bs-toggle="modal" data-bs-target="#newProduct" >New Item</button>
        </div>
        ...
        <div class="d-flex">
            <div class="dropdown d-inline mx-2  justify-content-end">
                ...
                <li><a class="dropdown-item border-radius-md" href="cekph">WWTP</a></li>
                </li>
        ...
        <div class="d-flex" id="reportrange" >
            ...
            <a href="/phprint/{{ $start }}/{{ $end }}/2" class="btn bg-gradient-info mx-2" target="_blank">
            ...
            <div class="table-responsive table-bordered">
                <table class="table table-striped table-bordered" id="datatable-search">
                    ...
                    <tr>
                        ...
                        <th rowspan="1" class="text-sm text-dark"  style="vertical-align : middle;text-align:center;">Aksi</th>
                    </tr>
                    </thead>
                    <tbody>
                        @foreach($group as $g)
                                ...
                                <tr >
                                    ...
                                    <td><button wire:click="sendData('{{ $d->id }}')" class="badge bg-gradient-danger"> Hapus </button>
                                ...
                                <tr >
                                  ...
                                  <td>{{ $p->shift }}</td>
                                    ...
                                    <td><button wire:click="sendData('{{ $p->id }}')" class="badge bg-gradient-danger"> Hapus </button>
    ...
    <div class="col-6">
        ...
        @error('nama_barang') <span class="text-danger error">{{ $message }}</span>@enderror
                    ...
                    <div class="modal-footer">
                      <button type="button" class="btn bg-gradient-secondary" data-bs-dismiss="modal" wire:click.prevent="cancel()">Keluar</button>
    ...
    <div class="col-6">
        ...
        @error('nama_barang') <span class="text-danger error">{{ $message }}</span>@enderror
                    ...
                    <div class="modal-footer">
                      ...
                      <button type="submit" class="btn bg-gradient-primary" data-bs-dismiss="modal" wire:click="update()">Simpan</button>
                    </form>
                    </div>
                  </div>
                </div>
