...
<div class="container">
<a class="navbar-brand  text-white " href="/test">
JMZ Movie
</a>
...
<div class="dropdown-menu dropdown-menu-animation dropdown-md p-3 border-radius-xl mt-0 mt-lg-3" aria-labelledby="dropdownMenuPages10">
...
<div class="dropdown-menu dropdown-menu-animation dropdown-xs dropdown-xs-responsive p-3 border-radius-lg mt-0 mt-lg-3" aria-labelledby="dropdownMenuBlocks">
...
<div>
<h6 class="dropdown-header text-dark font-weight-bolder d-flex justify-content-cente align-items-center p-0">Popular People</h6>
</div>
</div>
</div>
</a>
...
<div>
<h6 class="dropdown-header text-dark font-weight-bolder d-flex justify-content-cente align-items-center p-0">Discussions</h6>
</div>
</div>
</a>
</li>
...
<div>
<h6 class="dropdown-header text-dark font-weight-bolder d-flex justify-content-cente align-items-center p-0">Leaderboard</h6>
</div>
</div>
</a>
</li>
...
<div>
<h6 class="dropdown-header text-dark font-weight-bolder d-flex justify-content-cente align-items-center p-0">Support</h6>
</div>
</div>
</a>
</li>
...
<div>
<h6 class="dropdown-header text-dark font-weight-bolder d-flex justify-content-cente align-items-center p-0">API</h6>
</div>
</div>
</a>
</li>
...
<li class="nav-item">
<a href="/login" class="btn btn-sm  bg-gradient-primary  btn-round mb-0 me-1">Login</a>
</li>
</ul>
</div>
</div>
